...
class ProfileViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func createTransaction(_ sender: UIButton) {
        let storyBoard : UIStoryboard = UIStoryboard(name: "NewTransactionViewController", bundle: nil)
    ...
    func tableView(_ tableView: UITableView, accessoryButtonTappedForRowWith indexPath: IndexPath) {
        ...
        //DispatchQueue.main.async {
            ...
            let storyBoard : UIStoryboard = UIStoryboard(name: "TransactionViewController", bundle: nil)
